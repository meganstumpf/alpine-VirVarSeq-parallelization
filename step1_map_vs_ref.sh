...
#SBATCH --job-name=step1_map_vs_ref
#SBATCH --output=./log/step1_map_vs_ref_%j.log # Output log file from my Job
#SBATCH --error=./err/step1_map_vs_ref_%j.err # Output error file from my Job
...
#
./map_vs_ref.pl --samplelist $sample_name --ref $ref --indir $indir --outdir $outdir --mapping paired > VirVarSeq.log 2>&1
