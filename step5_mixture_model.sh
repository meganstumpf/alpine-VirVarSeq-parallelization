...
#SBATCH --job-name=step5_mixture_model
#SBATCH --output=./log/step5_mixture_model_%j.log # Output log file from my Job
#SBATCH --error=./err/step5_mixture_model_%j.err # Output error file from my Job
...
#
./mixture_model.pl --samplelist $sample_name --outdir $outdir --ref $ref --start=$region_start --len=$region_len --qual=$qv >> VirVarSeq.log 2>&1 
