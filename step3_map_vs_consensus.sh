...
#SBATCH --job-name=step3_map_vs_consensus
#SBATCH --output=./log/step3_map_vs_consensus_%j.log # Output log file from my Job
#SBATCH --error=./err/step3_map_vs_consensus_%j.err # Output error file from my Job
...
#
./map_vs_consensus.pl --samplelist $sample_name --indir $indir --outdir $outdir --mapping paired >> VirVarSeq.log 2>&1
